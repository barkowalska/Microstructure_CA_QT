...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButton->setGeometry(QRect(1000, 610, 80, 18));
        error_line = new QLineEdit(centralwidget);
        error_line->setObjectName(QString::fromUtf8("error_line"));
        error_line->setGeometry(QRect(20, 620, 811, 20));
